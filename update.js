            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '0 20px' }}>
              <div className="installer-card">
                ...
                <div className="installer-footer">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                  Powered by NEXUS
                </div>
              </div>
            </div>
...
const tailIndex = code.indexOf('<div className="setup-footer">');
const tail = code.substring(tailIndex);

const newCode = head + newStep3 + tail.replace('<div className="setup-footer">', '<div className="setup-footer">');
